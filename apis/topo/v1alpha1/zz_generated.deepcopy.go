...
func (in *NddotopologyTopologyLinkState) DeepCopyInto(out *NddotopologyTopologyLinkState) {
	*out = *in
	...
	if in.Tag != nil {
		in, out := &in.Tag, &out.Tag
		*out = make([]*NddotopologyTopologyLinkStateTag, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(NddotopologyTopologyLinkStateTag)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NddotopologyTopologyLinkStateTag) DeepCopyInto(out *NddotopologyTopologyLinkStateTag) {
	*out = *in
	if in.Key != nil {
		in, out := &in.Key, &out.Key
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NddotopologyTopologyLinkStateTag.
func (in *NddotopologyTopologyLinkStateTag) DeepCopy() *NddotopologyTopologyLinkStateTag {
	if in == nil {
		return nil
	}
	out := new(NddotopologyTopologyLinkStateTag)
...
func (in *NddotopologyTopologyNodeState) DeepCopyInto(out *NddotopologyTopologyNodeState) {
	*out = *in
	...
	if in.Tag != nil {
		in, out := &in.Tag, &out.Tag
		*out = make([]*NddotopologyTopologyNodeStateTag, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(NddotopologyTopologyNodeStateTag)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NddotopologyTopologyNodeStateTag) DeepCopyInto(out *NddotopologyTopologyNodeStateTag) {
	*out = *in
	if in.Key != nil {
		in, out := &in.Key, &out.Key
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NddotopologyTopologyNodeStateTag.
func (in *NddotopologyTopologyNodeStateTag) DeepCopy() *NddotopologyTopologyNodeStateTag {
	if in == nil {
		return nil
	}
	out := new(NddotopologyTopologyNodeStateTag)
...
func (in *NddotopologyTopologyState) DeepCopyInto(out *NddotopologyTopologyState) {
	*out = *in
	...
	if in.Tag != nil {
		in, out := &in.Tag, &out.Tag
		*out = make([]*NddotopologyTopologyStateTag, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(NddotopologyTopologyStateTag)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NddotopologyTopologyStateTag) DeepCopyInto(out *NddotopologyTopologyStateTag) {
	*out = *in
	if in.Key != nil {
		in, out := &in.Key, &out.Key
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NddotopologyTopologyStateTag.
func (in *NddotopologyTopologyStateTag) DeepCopy() *NddotopologyTopologyStateTag {
	if in == nil {
		return nil
	}
	out := new(NddotopologyTopologyStateTag)
