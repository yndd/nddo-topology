...
func initTopologyLink(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"endpoints": initTopologyLinkEndpoints,
		"state":     initTopologyLinkState,
		"tag":       initTopologyLinkTag,
	}
	e := &yentry.Entry{
		Name: "link",
		Key: []string{
