...
func initTopology(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"defaults": initTopologyDefaults,
		"kind":     initTopologyKind,
		"link":     initTopologyLink,
		"node":     initTopologyNode,
		"state":    initTopologyState,
	}
	e := &yentry.Entry{
		Name: "topology",
		Key: []string{
